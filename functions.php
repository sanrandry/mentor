...
function best_style_scripts()
{
	...
	wp_enqueue_style('bootstrap', get_template_directory_uri() . '/assets/vendor/bootstrap/css/bootstrap.min.css', array(), '1.1', 'all');
	wp_enqueue_style('iconfont', get_template_directory_uri() . '/assets/vendor/icofont/icofont.min.css', array(), '1.1', 'all');
	wp_enqueue_style('boxicons', get_template_directory_uri() . '/assets/vendor/boxicons/css/boxicons.min.css', array(), '1.1', 'all');
	wp_enqueue_style('owl-casousel', get_template_directory_uri() . '/assets/vendor/owl.carousel/assets/owl.carousel.min.css', array(), '1.1', 'all');
	wp_enqueue_style('animate', get_template_directory_uri() . '/assets/vendor/animate.css/animate.min.css', array(), '1.1', 'all');
	wp_enqueue_style('oas', get_template_directory_uri() . '/assets/vendor/aos/aos.css', array(), '1.1', 'all');

	wp_enqueue_script('jquery', get_template_directory_uri() . '/assets/vendor/jquery/jquery.min.js', array(), 1.1, true);
	wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/vendor/bootstrap/js/bootstrap.bundle.min.js', array(), 1.1, true);
	wp_enqueue_script('jquery-easing', get_template_directory_uri() . '/assets/vendor/jquery.easing/jquery.easing.min.js', array(), 1.1, true);
	wp_enqueue_script('validate', get_template_directory_uri() . '/assets/vendor/php-email-form/validate.js', array(), 1.1, true);
	wp_enqueue_script('jquery-waypoints', get_template_directory_uri() . '/assets/vendor/waypoints/jquery.waypoints.min.js', array(), 1.1, true);
	wp_enqueue_script('counterup', get_template_directory_uri() . '/assets/vendor/counterup/counterup.min.js', array(), 1.1, true);
	wp_enqueue_script('owl.carousel', get_template_directory_uri() . '/assets/vendor/owl.carousel/owl.carousel.min.js', array(), 1.1, true);
	wp_enqueue_script('aos', get_template_directory_uri() . '/assets/vendor/aos/aos.js', array(), 1.1, true);
...
function best_header_style()
{
	...
	<style type="text/css">
		...
		if ('blank' != $text_color) { ?>.best-site-title,
		.best-site-title a {
		...
		<?php }
		/* Display text or not */
		if (!$display_text) { ?>.best-site-title {
			display: none;
		}
...
require_once(get_template_directory() . '/inc/walker/Best-nav-walker.php');
